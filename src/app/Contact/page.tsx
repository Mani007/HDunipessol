    ...
    <div className="container  flex  flex-col bg-[#10375C] flex-wrap px-5 py-28 mx-auto md:items-center lg:items-start md:flex-row md:flex-no-wrap">
      ...
      <div className="grid  items-center gap-14 sm:p-8 p-4">
        <div>
          ...
          <p className="text-sm text-gray-300 mt-6 leading-relaxed">Have some big idea and need help? Then reach out to us. We love to hear from you.</p>
      ...
      <div className="flex-shrink-0 w-0 px-20 ">
      <Map/>
      </div>
    </div>
   </div>
