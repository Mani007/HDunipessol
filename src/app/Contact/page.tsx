...
function page() {
  return (
   ...
   <div className="w-full relative  text-gray-700 bg-[#10375C]  body-font">
    <div className="container  flex  flex-col bg-[#10375C] flex-wrap px-5 py-28 mx-auto md:items-center lg:items-start md:flex-row md:flex-no-wrap">
      
      <div className="grid  items-center gap-14 sm:p-8 p-4">
        <div>
          <h1 className="text-4xl font-semibold text-[#ffdc73]">Get in Touch</h1>
          <p className="text-sm text-[#ffdc73] mt-6 leading-relaxed">Have some big idea and need help? Then reach out to us. We love to hear from you.</p>
          ...
          <ul className="mt-12 space-y-8">
            <li className="flex items-center">
              ...
              <a href="javascript:void(0)" className="text-[#ffdc73] text-sm ml-4">
                info@example.com
              </a>
            </li>
            <li className="flex items-center">
